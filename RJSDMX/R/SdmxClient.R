...
getTimeSeries <- function(provider, dataflow, start='', end='') {
  res <- J("it.bankitalia.reri.sia.sdmx.client.SdmxClientHandler")$getTimeSeries(provider, dataflow, start, end)
...
getSDMX <- function(provider, dataflow, start='', end='') {
  getTimeSeries(provider, dataflow, start, end)
}
...
getCodes <- function(provider, dataflow, dimension){
  javaKeys<-J("it.bankitalia.reri.sia.sdmx.client.SdmxClientHandler")$getCodes(provider, dataflow, dimension)
