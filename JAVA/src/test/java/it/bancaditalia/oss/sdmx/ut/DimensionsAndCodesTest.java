...
public class DimensionsAndCodesTest
{
	@Parameters(name="{0} - {1}")
        ...
        return FilterProvidersToTest.filter(new Object[][] 
    		{
    			...
    			{ "ISTAT",    "144_125",                       "FREQ",       "A",   "annual",                      "[Dimension [id=FREQ, position=1, codelist=Codelist [id=IT1/CL_FREQ/1.0, codes={W=weekly, A=annual, H=half-yearly, Q=quarterly, E=event (not " },
