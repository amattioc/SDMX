 ...
 *
 */
public class SDMXHelperOld extends JFrame {
	...
	public SDMXHelperOld(boolean exitOnClose) {
    ...
    public static void start(){
		SDMXHelperOld h = new SDMXHelperOld(false);
		h.init();
    }

	public static void main(String argv[]) {
		SDMXHelperOld h = new SDMXHelperOld(true);
		h.init();
	}
}
