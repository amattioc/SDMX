	...
	public AboutContentFrame(){
		...
		try 
		{
			...
			while (mfs.hasMoreElements()) {
				...
				if (tmp.getPath().toLowerCase().contains("sdmx.jar")) 
				{
        ...
        root.registerKeyboardAction(closeListener, KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0), JComponent.WHEN_IN_FOCUSED_WINDOW);
